...
let f_aarch64_branch_conditional_test (type bitvector) (module I : IBI with type bitvector = bitvector) (v_enc : bitvector) (v_pc : bitvector) : unit = 
  if I.f_eq_bits (I.bigint_of_string "32") (I.f_and_bits (I.bigint_of_string "32") (v_enc) (I.from_bitsLit "10000000000000000000000000000000")) (I.from_bitsLit "10000000000000000000000000000000") then begin
    ...
    I.f_gen_store (I.v__PC) (I.f_gen_bit_lit (I.bigint_of_string "64") (I.f_add_bits (I.bigint_of_string "64") (v_pc) (I.f_SignExtend (I.bigint_of_string "16") (I.bigint_of_string "64") (I.f_append_bits (I.bigint_of_string "14") (I.bigint_of_string "2") (I.extract_bits (v_enc) (I.bigint_of_string "5") (I.bigint_of_string "14")) (I.from_bitsLit "00")) (I.bigint_of_string "64"))));
    ...
    let v_temp1 = I.f_gen_branch (I.f_gen_eq_bits (I.bigint_of_string "1") (I.f_gen_slice (I.f_gen_slice (I.f_gen_lsr_bits (I.bigint_of_string "32") (I.bigint_of_string "12") (!v_X_read15__2_copyprop) (I.f_gen_bit_lit (I.bigint_of_string "12") (I.f_ZeroExtend (I.bigint_of_string "6") (I.bigint_of_string "12") (I.f_append_bits (I.bigint_of_string "1") (I.bigint_of_string "5") (I.extract_bits (v_enc) (I.bigint_of_string "31") (I.bigint_of_string "1")) (I.extract_bits (v_enc) (I.bigint_of_string "19") (I.bigint_of_string "5"))) (I.bigint_of_string "12")))) (I.bigint_of_string "0") (I.bigint_of_string "1")) (I.bigint_of_string "0") (I.bigint_of_string "1")) (I.f_gen_bit_lit (I.bigint_of_string "1") (I.extract_bits (v_enc) (I.bigint_of_string "24") (I.bigint_of_string "1")))) in
