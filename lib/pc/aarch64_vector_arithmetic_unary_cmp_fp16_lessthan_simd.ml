...
let f_aarch64_vector_arithmetic_unary_cmp_fp16_lessthan_simd (type bitvector) (module I : IBI with type bitvector = bitvector) (v_enc : bitvector) (v_pc : bitvector) : unit = 
