...
let f_aarch64_vector_arithmetic_binary_uniform_add_wrapping_single_sisd (type bitvector) (module I : IBI with type bitvector = bitvector) (v_enc : bitvector) : unit = 
