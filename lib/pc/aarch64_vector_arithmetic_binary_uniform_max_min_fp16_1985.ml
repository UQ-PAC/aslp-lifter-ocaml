...
let f_aarch64_vector_arithmetic_binary_uniform_max_min_fp16_1985 (type bitvector) (module I : IBI with type bitvector = bitvector) (v_enc : bitvector) (v_pc : bitvector) : unit = 
