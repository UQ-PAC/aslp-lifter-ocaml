...
let f_aarch64_vector_arithmetic_unary_float_round_frint_32_64 (type bitvector) (module I : IBI with type bitvector = bitvector) (v_enc : bitvector) (v_pc : bitvector) : unit = 
