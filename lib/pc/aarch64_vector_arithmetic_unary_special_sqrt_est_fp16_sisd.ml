...
let f_aarch64_vector_arithmetic_unary_special_sqrt_est_fp16_sisd (type bitvector) (module I : IBI with type bitvector = bitvector) (v_enc : bitvector) (v_pc : bitvector) : unit = 
