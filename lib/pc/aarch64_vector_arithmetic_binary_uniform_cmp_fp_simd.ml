...
let f_aarch64_vector_arithmetic_binary_uniform_cmp_fp_simd (type bitvector) (module I : IBI with type bitvector = bitvector) (v_enc : bitvector) (v_pc : bitvector) : unit = 
