...
let f_aarch64_vector_arithmetic_unary_add_saturating_sisd (type bitvector) (module I : IBI with type bitvector = bitvector) (v_enc : bitvector) (v_pc : bitvector) : unit = 
